...
export const BOOKING_STATUS_DESCRIPTION: Record<BookingStatus, string> = {
  ...
  IN_PROGRESS: 'KOL đang triển khai chiến dịch hoặc chỉnh sửa nội dung theo feedback của Brand.',
  DELIVERED: 'KOL đã giao nội dung. Xem trước và chấp nhận, yêu cầu chỉnh sửa, từ chối hoặc khiếu nại. Nếu không phản hồi trong 3 ngày, hệ thống tự thanh toán cho KOL.',
